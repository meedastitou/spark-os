...
const testMachine = {
  ...
  variablesLowByteHighWordNoSwap: [{
    name: 'hrStringTest',
    description: 'HR String Test',
    format: 'char',
    type: 'hr',
...
describe('Spark HPL Modbus', () => {
  ...
  it('successfully create a new Modbus HPL', (done) => {
    ...
    sparkHplModbus.tester.prototype.setVariables(testMachine.variablesLowByteLowWordNoSwap);
    return done();
  });
  ...
  it('spark HPL modbus should produce data low byte first, low word first', (done) => {
    const readVariables = [];
    const gotDataForVar = [];
    testMachine.variablesLowByteLowWordNoSwap.forEach((variable) => {
  ...
  it('spark HPL modbus should produce data low byte first, high word first', (done) => {
    ...
    sparkHplModbus.tester.prototype.setVariables(testMachine.variablesLowByteHighWordNoSwap);
    ...
    const readVariables = [];
    const gotDataForVar = [];
    testMachine.variablesLowByteHighWordNoSwap.forEach((variable) => {
      if (!_.get(variable, 'machineConnected', false)
       && (_.get(variable, 'access', 'read') === 'read')) {
        readVariables.push(variable);
      }
  ...
  it('spark HPL modbus should produce data high byte first, low word first', (done) => {
    ...
    sparkHplModbus.tester.prototype.setVariables(testMachine.variablesHighByteLowWordSwap);
    sparkHplModbus.updateModel({
      enable: true,
      requestFrequency: 0.01,
      // highByteFirst: true,
    ...
    const readVariables = [];
    const gotDataForVar = [];
    testMachine.variablesHighByteLowWordSwap.forEach((variable) => {
      if (!_.get(variable, 'machineConnected', false)
       && (_.get(variable, 'access', 'read') === 'read')) {
        readVariables.push(variable);
      }
  ...
  it('spark HPL modbus should produce data high byte first, high word first', (done) => {
    ...
    sparkHplModbus.tester.prototype.setVariables(testMachine.variablesHighByteHighWordSwap);
    sparkHplModbus.updateModel({
      enable: true,
      requestFrequency: 0.01,
      // highByteFirst: true,
    ...
    const readVariables = [];
    const gotDataForVar = [];
    testMachine.variablesHighByteHighWordSwap.forEach((variable) => {
      if (!_.get(variable, 'machineConnected', false)
       && (_.get(variable, 'access', 'read') === 'read')) {
        readVariables.push(variable);
      }
